...
class Leaveapply extends Api_Controller 
{
    ...
    public function index_get() 
    {
        ...
        $this->retdata['leaveapplications'] = $this->leaveapplication_m->get_order_by_leaveapplication(array('schoolyearID' => $schoolyearID, 'create_usertypeID' => $this->session->userdata('usertypeID'), 'create_userID' => $this->session->userdata('loginuserID')));
        $this->retdata['leavecategorys'] = pluck($this->leavecategory_m->get_leavecategory(), 'leavecategory', 'leavecategoryID');
        $this->retdata['userNames'] = getAllUserObjectWithStudentRelationNameForApi($schoolyearID);
