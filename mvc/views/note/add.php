                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post">
                    ...
                    ?>
                        <label for="title" class="col-sm-2 control-label">
                            <?=$this->lang->line("note_title")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="description" class="col-sm-2 control-label">
                            <?=$this->lang->line("note_description")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="classesID" class="col-sm-2 control-label">
                            <?=$this->lang->line("note_classes")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">

                            <?php
                                $array = array();
                                $array[0] = $this->lang->line("note_select_classes");
                    ...
                    ?>
                        <label for="subjectID" class="col-sm-2 control-label">
                            <?=$this->lang->line("note_subject")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $array = array('0' => $this->lang->line("note_select_subject"));
                                if($subjects != "empty") {
                            ...
                            <div class="input-group image-preview">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default image-preview-clear" style="display:none;">
                                        ...
                                        <?=$this->lang->line('note_clear')?>
                                    </button>
                                    <div class="btn btn-success image-preview-input">
                                        <span class="fa fa-repeat"></span>
                                        <span class="image-preview-input-title">
                                        <?=$this->lang->line('note_file_browse')?></span>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_note")?>" >
                        </div>
                    </div>
